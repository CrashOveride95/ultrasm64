...
const LevelScript level_castle_grounds_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0_FS(     /*seg*/ 0x07, "ultrasm64/levels/castle_grounds/leveldata.szp"),
    LOAD_YAY0_FS(     /*seg*/ 0x0A, "ultrasm64/bin/water_skybox.szp"),
    LOAD_YAY0_FS_TEXTURE(/*seg*/ 0x09, "ultrasm64/bin/outside.szp"),
    LOAD_YAY0_FS(     /*seg*/ 0x05, "ultrasm64/actors/group10.szp"),
    LOAD_RAW(         /*seg*/ 0x0C, _group10_geoSegmentRomStart,  _group10_geoSegmentRomEnd),
    LOAD_YAY0_FS(     /*seg*/ 0x06, "ultrasm64/actors/group15.szp"),
