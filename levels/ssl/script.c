...
const LevelScript level_ssl_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0_FS(     /*seg*/ 0x07, "ultrasm64/levels/ssl/leveldata.szp"),
    LOAD_YAY0_FS(     /*seg*/ 0x0A, "ultrasm64/bin/ssl_skybox.szp"),
    LOAD_YAY0_FS_TEXTURE(/*seg*/ 0x09, "ultrasm64/bin/generic.szp"),
    LOAD_YAY0_FS(     /*seg*/ 0x05, "ultrasm64/actors/group5.szp"),
