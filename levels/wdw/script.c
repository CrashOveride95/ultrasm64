...
const LevelScript level_wdw_entry[] = {
    INIT_LEVEL(),
    LOAD_YAY0_FS(     /*seg*/ 0x07, "ultrasm64/levels/wdw/leveldata.szp"),
    LOAD_YAY0_FS_TEXTURE(/*seg*/ 0x09, "ultrasm64/bin/grass.szp"),
    LOAD_YAY0_FS(     /*seg*/ 0x0A, "ultrasm64/bin/wdw_skybox.szp"),
    LOAD_YAY0_FS(     /*seg*/ 0x05, "ultrasm64/actors/group1.szp"),
